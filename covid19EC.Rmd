...
tm = tm_shape(provincias) +
  ...
  tm_layout(
    title = 'Evolución de casos de COVID-19 en Ecuador por provincia',
...
**Contacto:** [Twitter](https://twitter.com/loreabad6), [GitHub](https://github.com/loreabad6)
