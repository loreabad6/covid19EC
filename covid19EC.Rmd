...
tm_shape(provincias) +
  ...
  tm_shape(provincias_casos %>% filter(fecha == max(fecha))) +
  tm_polygons(
    ...
    popup.vars = c("Casos" = "casos_confirmados_prov")
  ) 
  # tm_facets(along = 'fecha', free.coords = FALSE) +
...
* [ArcGIS dashboard de Edison Veloz Rubio](http://tamucc.maps.arcgis.com/){target="_blank"}
