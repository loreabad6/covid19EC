...
El código para reproducir las figuras, mapas y el sitio se encuentra en [GitHub](https://github.com/loreabad6/covid19EC){target="_blank"}. Todo es creado en R, con ayuda de los paquetes [sf](https://r-spatial.github.io/sf/){target="_blank"}, [ggplot2](https://ggplot2.tidyverse.org/){target="_blank"}, [tmap](https://github.com/mtennekes/tmap){target="_blank"}, [plotly](https://plotly.com/r/){target="_blank"}, [tidyr](https://tidyr.tidyverse.org/){target="_blank"} y [dplyr](https://dplyr.tidyverse.org/){target="_blank"}.
